...
public class LifeClassifyAdapter extends RecyclerView.Adapter<LifeClassifyAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_life_classify, parent, false);
